...
def md_to_html(md):
	...
	<html lang="zh"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>{T} | {DATE_STR}</title><style>{CSS}</style>{THEME_JS}</head><body>
